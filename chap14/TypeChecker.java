...
@Reviser public class TypeChecker {
	...
	@Reviser public static class ParamListEx2 extends TypedEvaluator.ParamListEx{

		public ParamListEx2(List<ASTree> list) {
			super(list);
			// TODO Auto-generated constructor stub
		}
	...
	@Reviser public static class VarStmntEx2 extends TypedEvaluator.VarStmnEx{
		protected TypeInfo varType, valueType;

		public VarStmntEx2(List<ASTree> list) {
			super(list);
			// TODO Auto-generated constructor stub
		}
		public TypeInfo typeCheck(TypeEnv tenv) throws TypeException{
